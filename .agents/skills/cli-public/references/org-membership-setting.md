...
csdk org-membership-setting create --entityId <UUID> [--createdBy <UUID>] [--updatedBy <UUID>] [--deleteMemberCascadeChildren <Boolean>] [--createChildCascadeOwners <Boolean>] [--createChildCascadeAdmins <Boolean>] [--createChildCascadeMembers <Boolean>] [--allowExternalMembers <Boolean>] [--inviteProfileAssignmentMode <String>] [--populateMemberEmail <Boolean>] [--limitAllocationMode <String>]
csdk org-membership-setting update --id <UUID> [--createdBy <UUID>] [--updatedBy <UUID>] [--entityId <UUID>] [--deleteMemberCascadeChildren <Boolean>] [--createChildCascadeOwners <Boolean>] [--createChildCascadeAdmins <Boolean>] [--createChildCascadeMembers <Boolean>] [--allowExternalMembers <Boolean>] [--inviteProfileAssignmentMode <String>] [--populateMemberEmail <Boolean>] [--limitAllocationMode <String>]
