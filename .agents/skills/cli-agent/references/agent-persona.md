...
csdk agent-persona create --slug <String> --name <String> [--createdBy <UUID>] [--updatedBy <UUID>] [--description <String>] [--systemPrompt <String>] [--resources <String>] [--config <JSON>] [--isActive <Boolean>]
csdk agent-persona update --id <UUID> [--createdBy <UUID>] [--updatedBy <UUID>] [--slug <String>] [--name <String>] [--description <String>] [--systemPrompt <String>] [--resources <String>] [--config <JSON>] [--isActive <Boolean>]
