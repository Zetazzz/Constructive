 ...
 */
export const createCaptchaMiddleware = (configuredSecretKey?: string): RequestHandler => {
  const secretKey = configuredSecretKey ?? getConstructiveEnvOptions().captcha?.recaptchaSecretKey;
