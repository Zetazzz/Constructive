...
const resolvePgpmEnvOptions = (
  ...
  return deepmerge.all(
    [defaultOptions, configOptions, envOptions, overrideOptions],
    {
...
export const getConnEnvOptions = (
  overrides: Partial<PgTestConnectionOptions> = {},
  cwd: string = process.cwd()
): PgTestConnectionOptions => {
...
export const getDeploymentEnvOptions = (
