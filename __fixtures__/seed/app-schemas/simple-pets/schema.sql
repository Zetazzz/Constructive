-- Shared fixture: simple-pets app schemas + animals table
--
-- Creates the simple-pets-public, simple-pets-private, and
-- simple-pets-pets-public schemas with an animals table.
--
-- Depends on: services/setup.sql (for stamps.timestamps, uuid-ossp, roles)
...
-- Set default privileges for simple-pets-public
...
-- Set default privileges for simple-pets-private
...
-- Set default privileges for simple-pets-pets-public
