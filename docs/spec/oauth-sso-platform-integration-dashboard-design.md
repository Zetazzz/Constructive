...
The verified Dashboard code baseline is remote `main` commit `892c85e491ff8acfe8a267c3bb3487b2488223c6` from 2026-08-06. The implementing PR must freeze and record the actual Dashboard and Constructive SHAs before code changes, regenerate typed GraphQL artifacts from that baseline, and reconcile any intervening route or authentication refactor.
