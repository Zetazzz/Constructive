/**
 * CLI commands for RealtimeModule
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    const defaultSelect = {
      ...
      subscriptionsSchemaId: true,
      changeLogTableId: true,
    ...
    const findManyArgs = parseFindManyArgs<
      FindManyArgs<RealtimeModuleSelect, RealtimeModuleFilter, RealtimeModuleOrderBy> & {
        select: RealtimeModuleSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.realtimeModule.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<
      FindFirstArgs<RealtimeModuleSelect, RealtimeModuleFilter> & {
        select: RealtimeModuleSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.realtimeModule
      .findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    const rawAnswers = await prompter.prompt(argv, [
      ...
      {
        type: 'text',
        name: 'subscriptionsSchemaId',
        message: 'subscriptionsSchemaId',
        required: false,
        skipPrompt: true,
      },
      {
        type: 'text',
        name: 'changeLogTableId',
        message: 'changeLogTableId',
        required: false,
        skipPrompt: true,
      },
      {
        type: 'text',
        name: 'listenerNodeTableId',
        message: 'listenerNodeTableId',
        required: false,
        skipPrompt: true,
      },
      {
        type: 'text',
        name: 'sourceRegistryTableId',
        message: 'sourceRegistryTableId',
        required: false,
        skipPrompt: true,
      },
      {
    ...
    const cleanedData = stripUndefined(
      answers,
      fieldSchema
    ) as CreateRealtimeModuleInput['realtimeModule'];
    const client = getClient();
    const result = await client.realtimeModule
      .create({
        data: {
          ...
          subscriptionsSchemaId: cleanedData.subscriptionsSchemaId,
          changeLogTableId: cleanedData.changeLogTableId,
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as RealtimeModulePatch;
    const client = getClient();
    const result = await client.realtimeModule
      .update({
        where: {
